package com.sin1.locate.service;
...
import com.sin1.locate.dao.ReplyLocateDAO;
import com.sin1.locate.dto.ReplyLocateDTO;
import com.sin1.util.PageObject;
import com.sin1.util.ReplyPageObject;

@Service
public class ReplyLocateService {
	@Inject
	private ReplyLocateDAO dao;
	
	// 댓글리스트
	public List<ReplyLocateDTO> list(ReplyPageObject pageObject){
		// pageObject
	...
	public ReplyLocateDTO view(int rno) {
		return dao.view(rno);
	}
	//	댓글 쓰기
	public void ReplyWrite(ReplyLocateDTO dto) {
		dao.ReplyWrite(dto);
	}
...
//	
	// 댓글수정
	public void ReplyUpdate(ReplyLocateDTO dto) {
		dao.ReplyUpdate(dto);
	}
