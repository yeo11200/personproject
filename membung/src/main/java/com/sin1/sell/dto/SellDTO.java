...
public class SellDTO {
	...
	public String toString() {
		return "SellDTO [no=" + no + ", hit=" + hit + ", title=" + title + ", content=" + content + ", writer=" + writer
				+ ", fileName=" + fileName + ", patid=" + patid + ", patage=" + patage + ", patgender=" + patgender
				+ ", patcolor=" + patcolor + ", writeDate=" + writeDate + ", multiFile=" + multiFile + "]";
	}
