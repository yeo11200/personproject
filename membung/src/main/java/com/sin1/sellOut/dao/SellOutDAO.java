...
public class SellOutDAO {
	...
	private final String NAME_SPACE = "com.sin1.mapper.SellOutMapper.";
									// com.sin1.mapper.SellOutMapper
	...
	// 게시판 업데이트
	public void update(SellOutDTO dto) {
